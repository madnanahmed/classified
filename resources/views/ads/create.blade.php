...
@section('content')
    ...
    <style>
        ...
        .jFiler-input-choose-btn{color:#ffffff!important;}
        ...
        #cke_content{
            margin: 1px 25px 0px 2px !important;
        }
        .cke_bottom{
        ...
        .reg-sidebar-inner .panel-heading {
            background: #eee;
        }
    </style>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <form id="wizard-validation-form" class="form-horizontal" action="#" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        ...
                                        <section>
                                                ...
                                                <div class="row">
                                                    @if($setting->hide_price == 0)
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="price" value="{{ (isset($ad_data))? $ad_data['price'] : '' }}"  type="text" class=" form-control" required onkeyup="check_number(this, 'number_only')" onpaste="check_number(this, 'number_only')" autocomplete="off">
                                            ...
                                            <div class="">
                                                <label class=" control-label" for="confirm2">Description <span class="text-danger">*</span></label>
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group clearfix m-b-10">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="address" value="{{ (isset($ad_data['address']) )? $ad_data['address'] : '' }}" required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group clearfix m-b-10">
                                                <label class="col-md-2 control-label" for="seller-Location">Location <span class="text-danger">*</span></label>
                                                <div class="col-md-10">
                                                    <input type="text" id="address-input" class="form-control locinput input-rel searchtag-input has-icon selecters" placeholder="Search location" autocomplete="off">
                                                    <input type="hidden" id="truecity" name="city" style="display:none;">
                                                    <input type="hidden" id="countryCode" name="country_code" style="display:none;"/>
                                                </div>
                                            </div>
                                            @if($setting->map_listings == 1)
                                                ...
                                                <div class="form-group clearfix m-l-15">
                                                    ...
                                                    <h4 class="m-t-0 header-title"><b>Add Location</b> to show ad on map</h4>
                                                    <p>Click on map to add pointer</p>
                                                    <div id="map"></div>
                ...
                <div class="col-md-3 reg-sidebar">
                    <div class="reg-sidebar-inner text-center m-t-10">
                        <div class="promo-text-box"><i class=" fa fa-image fa-4x icon-color-1"></i>
                                    ...
                                    <ul class="b-rounded-list">
                                        <li>
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">1: Rapidity</div>
                                                <p>Publish your adverts without waiting for notification by e-mail</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">2: Statistics</div>
                                                <p>Analyze ad performance, number of visits and responses</p>
                                            </div>
                                        </li>
                                        <li class="b-last">
                                            <div class="b-rounded-list-content">
                                                <div class="font-weight-bold">3: Visibility</div>
    ...
    <script>
        ...
        (function() {
            ...
            placesAutocomplete.on('change', function resultSelected(e) {
                ...
                $('#pac-input').val(e.suggestion.name); //copy the value
                initMap({lat: e.suggestion.latlng.lat || ''	, lng: e.suggestion.latlng.lng },10)

            });
        })();

        function initMap(lc=false,Zoom=3) {
