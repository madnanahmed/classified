...
<footer id="footer" class="clearfix">
    ...
    <section class="footer-top clearfix">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-8 col-md-8 col-sm-8 col-xs-6 pgs">
                ...
                <a href="{{url('/')}}" class="navbar-brand pull-right">
                  <img src="{{ asset('assets/images/logo-white.png')}}" alt="logo" class="img-responsive">
                </a>
                <div class="col-lg-12">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#google_translate_element').bind('DOMNodeInserted', function(event) {
                $('.goog-te-menu-value span:first').html('<i class="fa fa-language"></i> Select Language');
                $('.goog-te-menu-frame.skiptranslate').load(function(){
                    setTimeout(function(){
                        $('.goog-te-menu-frame.skiptranslate').contents().find('.goog-te-menu2-item-selected .text').html('<i class="fa fa-language"></i> Select Language');
                    }, 100);
                });
            });
        });
